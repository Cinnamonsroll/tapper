...
export default function Home() {
  ...
  return (
    <div className={`w-full h-screen flex items-center justify-center ${data.theme.background} ${data.theme.text}`} onClick={handleClick}>
      <Drawer.Root>
        <p className="text-5xl font-bold">{data.count}</p>
        <div className="absolute bottom-0 flex items-center justify-center p-3">
          <Drawer.Trigger>
            <div className="p-2 rounded-lg flex items-center justify-center backdrop-blur-md bg-white/30" onClick={openSettings}>
